...
namespace Catel.MVVM.Services
{
    ...
    /// <summary>
    /// Implementation of the <see cref="IGyroscopeService"/> interface.
    /// </summary>
    public class GyroscopeService : SensorServiceBase<IGyroscopeValue, GyroscopeValueChangedEventArgs>, IGyroscopeService
    {
        #region Fields
        private readonly Gyroscope _sensor;
        #endregion

        #region Constructors
        /// <summary>
        /// Initializes a new instance of the <see cref="GyroscopeService"/> class.
        /// </summary>
        ...
        /// </returns>
        public override IGyroscopeValue GetCurrentValue()
        {
            return new GyroscopeValue(_sensor.CurrentValue);
        }
        ...
        {
            var value = new GyroscopeValueChangedEventArgs(CurrentValue);
