...
namespace Catel.MVVM.Providers
{
        ...
        where TLogicType : LogicBase
    {
        ...
        {
            get { return Logic.PreventViewModelCreation; }
            set { Logic.PreventViewModelCreation = value; }
        }
        #endregion
        ...
        public new bool IsAssociatedObjectLoaded { get { return Logic.IsTargetViewLoaded; } }
        #endregion
        ...
        /// <param name="e">The <see cref="Catel.MVVM.Providers.DetermineViewModelInstanceEventArgs"/> instance containing the event data.</param>
        ...
        /// <summary>
        /// Called when a property on the <see cref="LogicBase.TargetView"/> has changed.
        /// </summary>
        /// <param name="sender">The sender.</param>
        /// <param name="e">The <see cref="System.EventArgs"/> instance containing the event data.</param>
        private void OnLogicTargetViewPropertyChanged(object sender, PropertyChangedEventArgs e)
        {
