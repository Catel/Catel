...
namespace Catel.MVVM.Providers
{
        ...
        where T : IView
    {
        ...
        public void OnNavigatingEvent(object sender, NavigatingCancelEventArgs e)
        {
            ...
            if (e.IsNavigationForView(TargetViewType))
            {
                _navigatingToViewComplete = false;
                _navigatingAwayFromViewCompleted = false;
            }
        ...
        /// this method must be called in both the constructor and the <see cref="OnTargetViewLoaded"/> methods.
        /// </summary>
        ...
        /// <returns><see cref="NavigationContextType"/> with all the data from the context.</returns>
        private static NavigationContextType ConvertNavigationContextToDictionary(NavigationContext context)
        {
            var dictionary = new NavigationContextType();
