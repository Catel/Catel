...
namespace Catel.Windows
{
    ...
    /// </summary>
    /// <remarks>
    /// This code originally comes from http://blogs.msdn.com/b/delay/archive/2009/11/02/as-the-platform-evolves-so-do-the-workarounds-better-settervaluebindinghelper-makes-silverlight-setters-better-er.aspx.
    /// </remarks>
#if NETFX_CORE
    ...
    public class SetterValueBindingHelper
    {
        ...
        private static void ApplyBinding(FrameworkElement element, SetterValueBindingHelper item)
        {
            ...
            else
            {
                ...
                if (null == type)
                {
                    ...
                    if (null == type)
                    {
                        ...
                        throw new ArgumentException(string.Format(CultureInfo.CurrentCulture, "Unable to access type \"{0}\". Try using an assembly qualified type name.", item.Type));
                    }
                }
            }
            ...
            var field = type.GetFieldEx(item.Property + "Property", true, true);
            if (null != field)
            {
            ...
            if (null == property)
            {
                ...
                throw new ArgumentException(string.Format(CultureInfo.CurrentCulture, "Unable to access DependencyProperty \"{0}\" on type \"{1}\".", item.Property, type.Name));
            }
        ...
        private static IEnumerable<Assembly> AssembliesToSearch
        {
            get
            {
                ...
                yield return typeof(Control).GetAssemblyEx();
