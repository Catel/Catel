namespace Catel.MVVM
{
    ...
    /// </summary>
    public static class FeaturedViewModelExtensions
    {
        /// <summary>
        ...
        public static bool IsValidationSummaryOutdated(this FeaturedViewModelBase viewModel, long lastUpdated, bool includeChildViewModelValidations)
        {
        ...
        /// <exception cref="ArgumentNullException">The <paramref name="viewModel"/> is <c>null</c>.</exception>
        public static IValidationSummary GetValidationSummary(this FeaturedViewModelBase viewModel, bool includeChildViewModelValidations)
        {
            ArgumentNullException.ThrowIfNull(viewModel);
        ...
        /// <returns>The validation summary.</returns>
        /// <exception cref="ArgumentNullException">The <paramref name="viewModel"/> is <c>null</c>.</exception>
        public static IValidationSummary GetValidationSummary(this FeaturedViewModelBase viewModel, bool includeChildViewModelValidations, object tag)
        {
            ArgumentNullException.ThrowIfNull(viewModel);
        ...
        /// </remarks>
        private static IValidationContext GetNestedValidationContext(FeaturedViewModelBase viewModel, bool recursive)
        {
