namespace Catel.MVVM
{
    ...
    public abstract partial class FeaturedViewModelBase : NavigationViewModelBase, IRelationalViewModel
    {
        ...
        private bool _supportIEditableObject;
        ...
        /// <summary>
        /// If set to <c>true</c>, the warning when using multiple models is ignored.
        /// </summary>
        [ExcludeFromValidation]
        protected bool IgnoreMultipleModelsWarning { get; set; }
        ...
        /// </value>
        [ExcludeFromValidation]
        protected bool SupportIEditableObject
        {
            get => _supportIEditableObject;
            set
            {
                // TODO: Consider only allowing this before initialization, then throw exception
                _supportIEditableObject = value;
            }
        }
        ...
        void IRelationalViewModel.SetParentViewModel(IViewModel? parentViewModel)
        {
            if (!ObjectHelper.AreEqualReferences(ParentViewModel, parentViewModel))
            {
                ...
                var parentVm = parentViewModel as FeaturedViewModelBase;
...
#pragma warning restore CTL0003 // Fix method name to match some property raising NotifyPropertyChanged event
        ...
        {
            var cancel = await base.CancelAsync();
