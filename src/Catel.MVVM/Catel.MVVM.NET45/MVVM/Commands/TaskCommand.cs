// --------------------------------------------------------------------------------------------------------------------
// <copyright file="TaskCommand.cs" company="Taggersoft">
...
namespace Catel.MVVM
{
        ...
        where TProgress : ITaskProgressReport
    {
        ...
        public TaskCommand(
            ...
            Func<TCanExecuteParameter, bool> canExecute = null,
            object tag = null)
            : this(canExecuteWithParameter: canExecute, tag: tag)
        {
        ...
        /// <param name="tag">The tag of the command.</param>
        public TaskCommand(
            Func<TExecuteParameter, CancellationToken, IProgress<TProgress>, Task> execute,
            Func<TCanExecuteParameter, bool> canExecute = null,
            Action<TProgress> reportProgress = null,
            object tag = null)
        ...
        ///     <see cref="Catel.MVVM.TaskCommand{TExecuteParameter,TCanExecuteParameter, TProgress}" /> class.
        /// </summary>
        /// <param name="canExecuteWithParameter">
        ///     The function to call to determine wether the command can be executed with
        ///     parameter.
        /// </param>
        /// <param name="canExecuteWithoutParameter">
        ///     The function to call to determine wether the command can be executed without
        ///     parameter.
        /// </param>
        /// <param name="reportProgress">Action is executed each time task progress is reported.</param>
        /// <param name="tag">The tag of the command.</param>
        internal TaskCommand(
            Func<TCanExecuteParameter, bool> canExecuteWithParameter = null,
            Func<bool> canExecuteWithoutParameter = null,
            Action<TProgress> reportProgress = null,
            object tag = null)
        {
        ...
        ///     be set to null.
        /// </param>
        /// <param name="ignoreCanExecuteCheck">
        ///     if set to <c>true</c>, the check on <see cref="CanExecute()" /> will be used before
