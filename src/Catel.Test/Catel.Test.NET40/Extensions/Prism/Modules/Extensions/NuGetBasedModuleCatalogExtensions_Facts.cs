...
namespace Catel.Test.Extensions.Prism.Modules.Extensions
{
    ...
    [TestClass]
    public class NuGetBasedModuleCatalogExtensions_Facts
    {
        ...
        {
            [TestMethod]
            public void Throws_ArgumentNullException_Self_Reference_IsNull()
            {
                NuGetBasedModuleCatalog nuGetBasedModuleCatalog = null;
                ExceptionTester.CallMethodAndExpectException<ArgumentNullException>(() => nuGetBasedModuleCatalog.GetPackageRepository());
            }
