...
namespace Catel.Runtime.Serialization.Json
{
    ...
    public class JsonSerializationContextInfo : Catel.Runtime.Serialization.ISerializationContextInfo
    {
