...
namespace Catel.Windows.Controls
{
    ...
    using Exceptions = Extensions.Controls.Properties.Exceptions;
    ...
    public static class ScrollViewerProperties
    {
        ...
        public static void OnFixScrollingPropertyChanged(object sender, DependencyPropertyChangedEventArgs args)
        {
            ...
            if (viewer == null)
            {
                throw new ArgumentException(Exceptions.DependencyPropertyCanOnlyBeAttachedToScrollViewer, "sender");
            }
