// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ExtensionsEntityFramework5Module.cs" company="Catel development team">
...
namespace Catel
{
    ...
    /// </summary>
    public class ExtensionsEntityFramework5Module : IServiceLocatorInitializer
    {
        /// <summary>
