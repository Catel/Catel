...
namespace Catel.Runtime.Serialization
{
    ...
    public class DataContractSerializerFactory : IDataContractSerializerFactory
    {
        ...
        public virtual DataContractSerializer GetDataContractSerializer(Type serializingType, Type typeToSerialize, string xmlName, object serializingObject = null, List<Type> additionalKnownTypes = null)
        {
