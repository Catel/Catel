...
namespace Catel.IoC
{
    ...
    public interface IDependencyResolver
    {
        ...
        /// <summary>
        /// Determines whether all types specified can be resolved. Though <see cref="CatelDependencyResolver.ResolveAll"/> will return <c>null</c>
        /// at the array index when a type cannot be resolved, this method will actually check whether all the specified types
        /// are registered.
        /// <para />
        /// It is still possible to call <see cref="CatelDependencyResolver.ResolveAll"/>, even when this method returns <c>false</c>.
        /// </summary>
