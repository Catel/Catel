...
namespace Catel.IoC
{
    ...
    public sealed class ServiceLocatorConfiguration : ConfigurationElementCollection
    {
        ...
        /// </param>
        /// <param name="supportDependencyInjection">
        /// Indicates whether the <see cref="IServiceLocator"/> configured with this section will support dependency injection or not.
        /// </param>
        public ServiceLocatorConfiguration(string name = "default", bool supportDependencyInjection = true)
        {
            this.Name = name;
            this.SupportDependencyInjection = supportDependencyInjection;
        }
        ...
        public bool SupportDependencyInjection
        {
            get
            {
                return (bool)this[SupportDependencyInjectionPropertyName];
            }

            set
            {
                this[SupportDependencyInjectionPropertyName] = value;
            }
        }
        ...
        /// <param ref="elementName">
        /// </param>
        /// is the collection element name.
        /// </summary>
        ...
        /// The instance of <see cref="IServiceLocator"/>
        /// </param>
        public void Configure(IServiceLocator serviceLocator)
        {
            serviceLocator.SupportDependencyInjection = this.SupportDependencyInjection;
