namespace Catel.Data
{
    ...
    public class PropertyData : PropertyData<object>
    {
        internal PropertyData(string name, object defaultValue,
            EventHandler<PropertyChangedEventArgs> propertyChangedEventHandler, bool isModelBaseProperty, bool isCalculatedProperty)
            : base(name, defaultValue, propertyChangedEventHandler, isModelBaseProperty, isCalculatedProperty)
        {
        }

        internal PropertyData(string name, Func<object> createDefaultValue,
            EventHandler<PropertyChangedEventArgs> propertyChangedEventHandler, bool isModelBaseProperty, bool isCalculatedProperty)
            : base(name, createDefaultValue, propertyChangedEventHandler, isModelBaseProperty, isCalculatedProperty)
        {
        }
    }
    ...
    public class PropertyData<T> : IPropertyData
    {
        ...
        internal PropertyData(string name, T defaultValue, EventHandler<PropertyChangedEventArgs>? propertyChangedEventHandler,
            bool isModelBaseProperty, bool isCalculatedProperty)
            : this(name, () => defaultValue, propertyChangedEventHandler, isModelBaseProperty, isCalculatedProperty) { }
