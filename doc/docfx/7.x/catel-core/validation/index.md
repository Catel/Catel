...
Validation is important for data objects. Therefore, the ModelBase supports all kinds of different validation:
...
The order of execution is important if you want to perform very advanced validation (such as translating validations at the end of each validation sequence).
...
There are many events, and it may seem complex and confusing at first sight. However, all these events give developers the opportunity to hook into the validation sequence at any time.
