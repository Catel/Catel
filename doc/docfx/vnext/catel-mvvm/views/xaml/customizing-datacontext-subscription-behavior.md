...
---
Starting with Catel 4.0, the views watch both the direct and inheritedÂ *DataContext*. Starting with Catel 4.1, it is possible to mimick the pre 4.0 `DataContext` subscription behavior.
...
It is also customize the behavior per view. This allows very customized fine tuning of the behavior. To use this feature, one needs to create a custom implementation of theÂ `IDataContextSubscriptionService`.
